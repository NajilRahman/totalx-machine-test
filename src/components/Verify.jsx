...
function Verify({ setState }) {
    ...
    return (
        ...
        <Col sm={6} className='my-2'>
            <img className='img-fluid rounded-pill my-4 shadow-lg' src={logo} alt="logo" style={{ width: '90px', height: '90px' }} />
            ...
            <div className='py-5 mx-4 w-75'>
                ...
                <small style={{ color: '#313131' }} className='mt-2 mb-5'>Login to access your travelwise  account</small>
