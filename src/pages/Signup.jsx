            ...
            <Row className='  d-flex justify-content-center ' style={{ height: '60vh', paddingInline: '6vw' }}>
                ...
                <Col sm={6} className='my-2'>
                    ...
                    <div className=' mx-4 w-75'>
                        ...
                        <small style={{ color: '#313131' }} className='mt-2 mb-5'>Let’s get you all st up so you can access your personal account.</small>
                        <form onSubmit={handleSubmit}>
                            ...
                            <span className=''> <input type="checkbox"  className='me-2'/> <small>I agree to all the <span style={{ color: '#FF8682' }}>terms</span> and <span style={{ color: '#FF8682' }}>Privacy Policies</span></small></span>
